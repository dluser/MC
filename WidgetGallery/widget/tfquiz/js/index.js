...
var quizJSON = {
    "info": {
        "results": "<h5>Learn More</h5><p> Well done</p>",
        "level1":  "Well done, you have achieved perfection!",
        "level2":  "Good work, you have scored a letter grade of A for this quiz. ",
        "level3":  "Could be better... you have scored a letter grade of C.",
        "level4":  "Do more research and retake the quiz, you have scored a letter grade of D.",
        "level5":  "Better luck next time... You have failed this quiz." // no comma here
    },
    "questions": [
        { // Question 1 - True or False
            "q": "Lightning never strikes in the same place twice.",
            "a": [
                {"option": "True",      		"correct": true,"count":"20"},
                {"option": "False",      		"correct": false,"count":"0"},
				
            ],
          
        },
        { // Question 2 - True or False
            "q": "If you cry in space, the tears stick to your face.",
            "a": [
                {"option": "True",               "correct": true,"count":"20"},
                {"option": "False",   			 "correct": false,"count":"0"},
        ...
        { // Question 3 - True or False
            ...
            "a": [
                {"option": "True",           	"correct": true,"count":"20"},
                {"option": "False",          	"correct": false,"count":"20"},
    ...
    $.slickQuiz = function(element, options) {
        ...
        plugin.method = {
            ...
            checkAnswer: function(checkButton) {
				...
				if(selectedAnswers[j]==answers[i].option){
				totalCount=totalCount+parseInt(answers[i].count);
                ...
                var correctResponse = plugin.method.compareAnswers(trueAnswers, selectedAnswers, selectAny,answerCount);
            ...
            completeQuiz: function() {
                ...
                $(_quizScore + ' span').html(totalCount + '   ');
            ...
            compareAnswers: function(trueAnswers, selectedAnswers, selectAny,answerCount) {
                if ( selectAny ) {
